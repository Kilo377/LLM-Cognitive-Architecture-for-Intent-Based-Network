function run_xapp_fairness_guard_compare()
    ...
    cases = {
        "baseline", [];
        "fairness_scheduler", ["xapp_fairness_scheduler"];
        "fairness_no_thr_loss", ["xapp_fairness_no_thr_loss"];
        "fairness_no_drop_loss", ["xapp_fairness_no_drop_loss"];
        "fairness_all", ["xapp_fairness_scheduler", "xapp_fairness_no_thr_loss", "xapp_fairness_no_drop_loss"]
    };
...
function printSummary(results)
    ...
    fprintf("\n===== xApp Fairness Guard KPI Summary =====\n");
...
function plotSummary(results, caseNames)
    ...
    figure('Name','xApp Fairness Guard Compare');
